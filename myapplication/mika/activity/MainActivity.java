...
import com.example.myapplication.mika.adaptor.CategoryAdaptor;
import com.example.myapplication.mika.adaptor.PopularAdaptor;
...
public class MainActivity extends AppCompatActivity {
    ...
    private  void recyclerViewPopular(){
        ...
        foodList.add(new FoodDomain("Vegetable Pizza","pizza2","olive oil, vegetable oil, pitted taramasalata, cherry tomatoes, fresh oregano, basil",8.5));
